...
const VideoDeposition = ({ author, ocuppation, videoUrl, imageUrl, imageAlt }) => {
  ...
  return (
    <div className={`${styles.depositionItem} ${styles.depositionItemVideo}`} onClick={handleVideoModalOpen}>
      <Modal
      ...
      <div className={[styles.depositionItemContent]}>
        <img className={[styles.depositionItemContentImage]} src={imageUrl} alt={imageAlt} />
