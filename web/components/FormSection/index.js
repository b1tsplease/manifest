    ...
    <div className={styles.formSectionContent}>
      <form className={styles.form}>
        <div className={styles.formGroup}>
          ...
          <input id="formName" className={styles.formControl} placeholder="Ex.: Luiz Castro" />
        </div>
        <div className={styles.formGroup}>
          <label for="formEmail" className={styles.formLabel}>E-mail</label>
          <input id="formEmail" className={styles.formControl} placeholder="Ex.: nome@mail.com" />
        </div>
        <div className={styles.formGroup}>
          <label for="formOccupation" className={styles.formLabel}>Ocupação</label>
          <input id="formOccupation" className={styles.formControl} placeholder="Ex.: Estudante" />
        </div>
      ...
      <div className={styles.signaturesInfoContainer}>
        <div className={styles.signaturesInfo}>
          ...
          <ul className={styles.signaturesList}>
            <li className={styles.signatureItem}><strong>Letícia Y.</strong> assinou há 8 minutos</li>
            <li className={styles.signatureItem}><strong>Anderson S.</strong> assinou há 22 minutos</li>
            <li className={styles.signatureItem}><strong>Rafael L.</strong> assinou há 37 minutos</li>
          </ul>
        </div>
      </div>
    </div>
